...
namespace ContosoUniversity.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> EditPost(int? id, string[] selectedCourses)
        {
            ...
            if(await TryUpdateModelAsync<Instructor>(instructorToUpdate,"",i=>i.FirstMidName,i=>i.LastName,i=>i.HireDate,i=>i.OfficeAssignment))
            {
                ...
                catch (DbUpdateException)
                {
                    ...
                    ModelState.AddModelError("", "Unable to save changes. " + "Try again, and of the problem persists, " + "see your system adminstrator.");
                }
        ...
        private void UpdateInstructorCourses(string[] selectedCourses, Instructor instructorToUpdate)
        {
            ...
            {
                //首先被选中的CourseID在所有CouseID范围之内
                if(selectedCoursesHS.Contains(course.CourseID.ToString()))
                {
                    //并且被选中的CouseID没有包含在Instructor当前的CouseIDs中
